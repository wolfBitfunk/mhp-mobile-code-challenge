...
object BookResponseTestFixture {
    ...
    val JSON_COMPLETE_TEST_EXAMPLE = """
            {
            	...
            	"country": "testBookCountry",
            	"mediaType": "testBookMediaType",
            	...
            	"povCharacters": [
            		"testBookPovCharacter1",
            		"testBookPovCharacter2"
            	]
            }
        """.trimIndent()
    ...
    val COMPLETE_TEST_EXAMPLE = BookResponse(
        url = "testBookUrl",
        name = "testBookName",
        isbn = "testBookIsbn",
        authors = listOf("testBookAuthor1"),
        numberOfPages = 123,
        publisher = "testBookPublisher",
        country = "testBookCountry",
        mediaType = "testBookMediaType",
        released = "1996-08-01T00:00:00",
        characters = listOf("testBookCharacter1", "testBookCharacter2"),
        povCharacters = listOf("testBookPovCharacter1", "testBookPovCharacter2"),
    )
