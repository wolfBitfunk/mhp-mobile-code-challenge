...
object HouseResponseTestFixture {
    ...
    val COMPLETE_TEST_EXAMPLE = HouseResponse(
        url = "testHouseUrl",
        name = "testHouseName",
        region = "testHouseRegion",
        coatOfArms = "testHouseCoatOfArms",
        words = "testHouseWords",
        titles = listOf("testHouseTitle1", "testHouseTitle2", "testHouseTitle3"),
        seats = listOf("testHouseSeat1", "testHouseSeat2"),
        currentLord = "testHouseCurrentLord",
        heir = "testHouseHeir",
        overlord = "testHouseOverlord",
        founded = "testHouseFounded",
        founder = "testHouseFounder",
        diedOut = "testHouseDietOut",
        ancestralWeapons = listOf("testHouseAncestralWeapon1", "testHouseAncestralWeapon2"),
        cadetBranches = listOf("testHouseCadetBranch1"),
        swornMembers = listOf("testHouseSwornMember1", "testHouseSwornMember2"),
    )
